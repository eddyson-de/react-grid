        ...
        SortHandler.propTypes = {
            ...
            sort: function(props, propName, componentName, ...rest) {
                ...
                if (!props.onChangeSort){
                    return new Error('You provided a `sort` prop without an `onChangeSort` handler. This will lead to constant sorting. If you want to set the default sorting, use the `initialSort` prop.'); 
                }
