...
class RowView extends Component {
    ...
    render(){
        const { props: {object, columnConfigs, objects, rowIndex}, context: {defaultCellContent, row: Component, cell} } = this;
        return (
            <Component object={object} columnConfigs={columnConfigs} rowIndex={rowIndex} objects={objects}>
